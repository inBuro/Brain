...
- **ВСЕ 6 слотов Control XL = `44aa142b198b6001613db3b29c36cc38`**, 211548 B (чистая до-фичная версия после отката Browser Load 2026-06-06 (14)). Без `bl_*` / `deferlow bl_defer` / `bl_ui_btn` / browser-js. User Library (слот 2) и проектный эталон (слот 1) восстановлены пользователем; бандлы 3–6 не менялись. Инвариант байт-в-байт ВЫПОЛНЕН.
