---
name: career
description: Роутер группы job-search/career (1 свой подскилл + индекс 22 глобальных резюме-скиллов). Применять при задачах на поиск вакансий, резюме, cover letter, LinkedIn, собеседования, переговоры о зарплате, сравнение офферов, карьерный кейс-стади — весь путь кандидата от мониторинга вакансий до готового отклика.
---

# Career — роутер группы

Единственный физически владеемый подскилл — `subskills/telegram-vacancy-mining/SKILL.md` (майнинг вакансий из Telegram-каналов). Остальное — глобальный резюме/job-search бандл в `~/.claude/skills/` (не переносится: вендорский набор без общей структуры для переноса, дедуп — на уровне функции). Этот роутер — индекс поверх него, чтобы 22 скилла не терялись плоским списком.
...
| Развернуть буллет в портфолио-кейс-стади | portfolio-case-study-writer |
