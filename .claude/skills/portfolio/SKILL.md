...
| Любая задача на Notion в этом контуре — ревью кейса через комментарии, реструктуризация страниц, медиа, синхронизация с сайтом (не про голос текста — это `portfolio-writer`) | subskills/notion |
