...
### 2026-05-09 12:08 ICT — auto check

**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist; 26th consecutive affected run). Sources: CoinMarketCap, CoinGecko, AltIndex, Investing.com, CoinGlass, MEXC/Binance price feeds, FXStreet, The Market Periodical, Finance Magnates, SpotedCrypto, fx.co. Python-computed indicators from approximate 4H close sequence (Apr 30 $2,259 → May 6 HH $2,400 → May 8 LL $2,261 → May 9 $2,316). Precision ±5%; treat indicator estimates as directional, not exact.

**Price**: $2,316 (Δ +1.08% 24h; 24h high ~$2,335; 24h low $2,261 [May 8 LL still holding]; vol ~$18.97B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high $2,335, low $2,261 (May 8 LL confirmed holding through overnight and morning); vol ~$18.97B USDT
- 3h consolidation: price has been in a tight $2,312–$2,320 band from 09:11 through 12:08 ICT — sideways post-recovery, no new pullback or breakout observed
- BTC: est. ~$81,000 (below 1D EMA200 ~$82,127; gap ~1.4%; slightly higher than prior run estimate of $79,743–$80,394; BTC tested EMA200 May 7, was rejected, now $81K)
- 1D: RSI est. ~47–52 (neutral, recovering); MACD est. positive (est. +5; Python computation unreliable with <15 daily closes — web aggregate used); EMA200 1D ~$2,367, EMA50 1D ~$2,211; price below EMA200 ($2,367) by ~$51, above EMA50 ($2,211) by ~$105
- 4H structure: HH $2,400 (May 6) → HL $2,261 (May 8 LL confirmed as HL since $2,261 > prior LL $2,220) → recovery to $2,316 → 3h sideways consolidation. Structure: HL confirmed; no new impulse or pullback in last 3h. Price below 4H EMA100 (~$2,340) and 4H EMA50 (~$2,307 est.)
- 4H MACD (Python, from approx close sequence): MACD line −3.6, signal +1.6, histogram −5.2 (contracting). Note: prior run (10:09 ICT) computed +5.0 / +13.3 / −8.3 from slightly different close sequence. Both computations place 4H MACD in the [−10, +10] range. Web aggregate (AltIndex/Investing.com) reports histogram ~−0.7 (contracting). Directional consensus: 4H MACD near zero, histogram contracting = convergence / momentum recovery, but not yet positive cross-confirmed
- 4H RSI (Python): 30.4 — estimate likely too low due to limited data points; web aggregates suggest 4H RSI ~46–52 (neutral); using web estimate
- 1H: RSI est. ~55–58 (exited <40 zone; bounced to neutral; web: AltIndex 57.75); MACD line est. +14.6, signal +10.9, histogram +3.7 (Python; 1H MACD clearly bullish); price holding above 1H EMA50 est. ($2,290) and 1H EMA200 est. ($2,287)
- 15m: RSI est. ~50–55 (neutral; stabilizing after overnight bounce); no reversal candle at current $2,316 level (price floating mid-range)
- ATR(14) 1H: Python estimate ~$15.2 (note: based on limited sequence; web aggregate suggests ~$11–13, declining from ~$13.5 at May 8 close); declining but <24h confirmed
- BB 4H (Python): lower $2,241 / mid $2,330 / upper $2,419; price ($2,316) inside bands, near mid; bands appearing to stabilize (not expanding further as of morning session)
- Funding: −0.0020%/8h (unchanged from prior run; negative = shorts pay longs; mild structural LONG support)
- OI: ~$5B Binance, ~$33.6B all exchanges (manual verification needed — API blocked; consistent with prior run)
- L/S ratio: est. 56% long / 44% short (1.28 ratio per web aggregates); manual verification needed (Bybit Trading Trend not accessible via API)
- ETH Spot ETF flows: May 1–6 confirmed positive ($270M+ cumulative); May 7–9 data pending manual verification
- BTC Spot ETF flows: Outflows $268.5M (May 7); May 8–9 data pending; BTC tested EMA200 May 7 and was rejected
- Whale activity: 140K–230K ETH accumulated by large wallets in last 96h (~$322M notional); directional signal: bullish; Bybit Trading Trend ratio: manual verification needed

**Pre-checks**:

**Watch criteria status (updated from 10:09 ICT run)**:
- Criterion A (1H RSI exited <40 zone): STILL MET ✓ (RSI ~55–58; well above 40)
- Criterion B (4H MACD in [−10,+10]): STILL MET ✓ (both computations confirm; web aggregate confirms contracting histogram near zero)
- Criterion C (price above $2,287 reclaim level): STILL MET ✓ ($2,316; +$29 above reclaim)
- New data point: 3h sideways consolidation at $2,312–2,320. No pullback to HL zone ($2,270–2,290) observed. Bullish case: accumulation base; bearish case: fading recovery preparing to roll over.

**Multi-TF alignment (LONG)**:
- 4H: HL $2,261 confirmed ✓; MACD convergence toward zero (histogram contracting) ✓; BUT price below 4H EMA100 ($2,340) ✗; MACD cross-of-zero not confirmed (conflicting Python runs; directional lean: near zero, slightly negative) ✗
- 1H: RSI exited <40 zone ✓; MACD histogram +3.7 (bullish) ✓; BUT RSI neutral (~55–58; not in oversold zone required for full alignment) ✗; no HL pullback-confirm on 1H (straight recovery) ✗
- 15m: RSI ~50–55 (neutral) ✓; no reversal candle at current level ($2,316 mid-air; not at any support) ✗
- Verdict: FAIL — directional improvement clear vs prior sessions; structural conditions partially developing; but 15m reversal candle missing, price not at actionable level, 4H EMA100 not reclaimed, RSI neutral not oversold

**Multi-TF alignment (SHORT)**: FAIL — price at $2,316 recovering; no LH at resistance; RSI ~55–58 neutral; 4H MACD converging toward zero (not bearish); no alignment

**Range pre-check**:
- Gate 1 — 4H MACD in [−10,+10]: PASS ✓ (both Python computations and web aggregate confirm; third consecutive hourly run with gate 1 passing)
- Gate 2 — ATR(14) 1H declining 24h+: FAIL ✗ (declining from ~$13.5 but elapsed time <24h since LL; est. now ~$11–13; need 24h of confirmed contraction from a local high)
- Gate 3 — horizontal range, 2+ rejections each edge: FAIL ✗ (lower edge $2,261 = 1 touch; 24h high $2,335 = 1 touch; 2nd rejections not yet confirmed)
- Gate 4 — BB(20,2) 4H flat: PARTIAL ✗ (bands stabilizing after prior expansion; not yet confirmed flat; needs another 4–8h of price stability to confirm)
- Verdict: FAIL — gate 1 remains the only pass; development trajectory positive (gate 2 progressing, gate 4 stabilizing), but structure not yet formed

**News Impact Score** (window 12:08–13:08 ICT):

| Event | Score | Direction vs LONG |
|---|---|---|
| US-Iran peace deal optimism (risk-on; May 9 morning reports) | 2×3×0.75 = 4.5 | Neutral/mildly pro-LONG (contrary to prior risk-off narrative; applying contrary modifier 0.75) |
| NFP April 2026 (+115K vs +62K; released ~14h ago; absorbed) | 2×3×0.75 = 4.5 | Against LONG (informational; market bounced contrary; contrary modifier applied) |
| Kevin Warsh as Fed Chair May 15 (forward macro concern) | 1×3×1.0 = 3.0 | Against LONG (informational; event is May 15, not today) |
| ETH Spot ETF inflow streak (May 1–6, $270M+ cumulative) | 2×1.5×1.25 = 3.75 | Pro-LONG (trend confirmation) |
| No macro event in next 1–2h (FOMC: June 16–17; CPI: not today) | — | Clear ✓ |

Max individual score: 4.5 < 10 → informational, no size reduction. No prohibitive headlines active. ✓

**Base conditions (LONG)**:
- BC1 (price at strong support): FAIL ✗ — $2,316 mid-range; the actionable support zone was $2,261 LL (now +$55 above); next support est. $2,287 (reclaim level); price is between support levels, not at one
- BC2 (RSI 1H <40 or RSI 4H <45): FAIL ✗ — RSI 1H ~55–58; RSI 4H ~46–52; both in neutral territory; recovery has already moved RSI well out of the oversold zone
- BC3 (4H structure starts to reverse — HL forming or double bottom): PARTIAL ✗ — HL $2,261 confirmed vs prior LL $2,220 ✓; BUT the recovery has been a single impulse without a confirming pullback HL; 3h consolidation at $2,316 may be that consolidation forming, but it needs to test lower and hold to confirm
- BC4 (whale ratio >1.2 long): LIKELY PASS ✓ — L/S ratio est. 1.27–1.30 per web aggregates; manual verification still needed
- BC5 (1D trend not catastrophically bearish): PASS ✓ — 1D MACD est. positive per web aggregates; Prohibitive #6 NOT triggered; price above EMA50 1D
- Confirmed: 1.5–2 of 5 (BC4 likely + BC5 confirmed; BC3 partial). Insufficient for entry (need ≥3 confirmed).

**Prohibitive conditions (LONG)**:
- #1 (fresh daily support break): NOT triggered — $2,316 above $2,287 reclaim ✓
- #2 (whale ratio <0.8): Likely NOT triggered — L/S 1.27–1.30 (bullish); manual check needed ✓?
- #3 (funding strongly positive >0.025%): NOT triggered — funding −0.0020%/8h ✓
- #4 (inflow dominates): Likely NOT triggered — ETF inflows positive; exchange net flow unknown; manual check needed ✓?
- #5 (mixed-market momentum trade): Not applicable ✓
- #6 (counter-trend bearish: 1D MACD <0 AND BTC <EMA200): NOT triggered — 1D MACD est. positive; Prohibitive #6 requires BOTH conditions ✓
- #7 (critical news): NOT triggered — no prohibitive headline today ✓
- No prohibitive conditions blocking LONG

**Reasoning**:
- **LONG — NO_SETUP**: Third consecutive run (09:11 / 10:09 / 12:08 ICT) with the same structural picture. ETH has been consolidating at $2,312–2,320 for 3 hours post-LL recovery. The key setup-enabling conditions remain unmet: BC1 (price not at support), BC2 (RSI neutral ~55–58, not <40 on 1H or <45 on 4H), BC3 (HL structurally forming but not yet confirmed via confirming pullback). Of the 5 base conditions, only BC4 (whale ratio likely >1.2) and BC5 (1D trend not catastrophically bearish) are satisfied — 2 of 5, below the required ≥3. Multi-TF alignment also fails on 1H RSI and 15m reversal. No improvement in setup eligibility vs prior runs despite 3h elapsed.
- **New observation — 3h consolidation**: The price holding $2,312–2,320 for 3 hours without a meaningful pullback or breakout has two interpretations: (a) base-building / accumulation base suggesting buyers are defending the level before a breakout above $2,340 EMA100; (b) post-bounce exhaustion with a rollover toward the HL zone ($2,270–2,290) pending. Neither is confirmed yet. The consolidation does NOT constitute a reversal candle setup on 15m (price is not at any actionable level — it's mid-range floating).
- **SHORT — NO_SETUP**: No alignment, no base conditions. 4H MACD converging toward zero (not bearish). RSI neutral. Price recovering. No short case.
- **RANGE — NO_SETUP**: Gate 1 passes (3rd consecutive run). Gates 2/3/4 still developing. The 3h consolidation at $2,312–2,320 is structurally positive for range formation — if this band holds 6+ more hours with the ATR continuing to contract and a second rejection forming at the 24h high ($2,335), gate 3 could approach pass by the 18:00–19:00 ICT runs. Not yet ready.
- **Pending order eligibility (LONG)**: NOT eligible per pending-orders.md criteria. Condition 3 ("structural pre-checks PASS NOW") is not met — multi-TF alignment fails at current price. Pre-placing a limit at $2,278 (HL retest) would be premature because if price doesn't pull back, the order sits idle; if price drops directly below $2,261 invalidating the HL structure, the order fires into a broken setup. The correct action remains: WATCH for a pullback to $2,270–2,290, confirm reversal candle on 15m, then evaluate alignment live.
- **US-Iran peace deal optimism** (new this run): Risk sentiment improving today per web reports (potential peace deal progress). This slightly reduces the prior "US-Iran tensions" Impact Score from 12.0 down to 4.5 (applying contrary modifier 0.75 since the geopolitical narrative is shifting bullish, contrary to prior risk-off assumption). Net improvement for LONG news context.
- **BTC improvement**: BTC at ~$81,000 (slightly higher than prior est. $79,743–$80,394). Still below EMA200 ($82,127), so Prohibitive #6 BTC side still applies in theory; but ETH 1D MACD remaining positive means #6 is not triggered overall.
- **Primary blocker**: Price mid-range ($2,316); RSI neutral (not oversold); 3h consolidation not equivalent to reversal setup; base conditions 2/5 only.
- **Watch triggers for upcoming runs**: (a) Price pulls back to $2,270–2,290 with 15m reversal candle → evaluate LONG setup live; (b) Price breaks above $2,340 (4H EMA100) with volume → potential different LONG setup scenario, re-evaluate; (c) Second rejection at $2,335 24h high develops → range gate 3 progress; (d) ATR 1H continues declining toward $10–11 → gate 2 approaching pass.

**Live setup details**: N/A

**Pending order suggestion**: N/A — structural pre-checks not currently passing; pending-orders.md condition 3 not met. Watch scenario unchanged: pullback to $2,270–2,290 HL retest with 15m reversal candle would trigger live evaluation. Pre-emptive limit order not warranted without 15m confirmation.

**Manual verification needed**:
- Whale ratio from Bybit Trading Trend (app → Data → Trading Trend; L/S est. 1.27–1.30 per web but needs direct verification)
- ETH Spot ETF flows May 7–9 (Farside Investors / The Block; inflow streak continuation?)
- BTC 1D MACD sign (positive or negative — impacts Prohibitive #6 on BTC side if ETH 1D MACD deteriorates)
- Exchange net inflow/outflow (Prohibitive #4 check; web data suggests ETF outflow from exchanges = mildly bullish, but unverified)
- ATR 1H on live chart (Python estimate ~$15 likely overstated vs web ~$11–13; live chart required)
- 15m chart: any consolidation pattern or range forming at $2,310–2,320?
- US-Iran peace deal status (if confirmed, reduces news risk score; if failed, reinstates risk-off)

**Telegram sent**: no (curl returned "Host not in allowlist"; 26th consecutive run with Telegram blocked by sandbox egress; check journal directly)

---

### 2026-05-09 19:14 ICT — auto check

**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist; 27th consecutive affected run). Sources: CoinGecko, CoinMarketCap, Gate.com, AltIndex, Investing.com, Barchart, CoinGlass, Fortune (May 8 article), CryptoRank (May 6 BTC data). Price cross-referenced across three spot venues; precision ±1% on price, ±5% on indicator estimates. 4H MACD directional consensus carried from 09:11/10:09/12:08 ICT Python computations and web aggregates.

**Price**: $2,316 (Δ +0.94% 24h; 24h high $2,321; 24h low $2,265; vol ~$19.8B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high $2,321, low $2,265, vol ~$19.8B USDT (spot; futures vol ~$39.4B per CoinGlass)
- Key observation: ETH has consolidated in a tight $2,312–2,321 band for approximately 10 hours (since 09:11 ICT). Price delta over 10h: ~$0. This is the 4th consecutive run with no material price change.
- BTC: est. ~$80,500–$81,500 (May 9; May 6 confirmed $81,250 vs EMA200 ~$82,128–$82,228; still below EMA200; manual verification needed for May 9 exact value)
- 1D: RSI est. ~48–52 (neutral, recovering); MACD line est. positive (+5; carried from 10:09/12:08 ICT runs) → Prohibitive #6 NOT triggered (requires BOTH 1D MACD <0 AND BTC <EMA200; only 1 leg active); EMA200 1D ~$2,616 (price 12.3% below); EMA50 1D ~$2,265 (Barchart; price above by ~$51)
- 4H structure: HH $2,400 (May 6) → HL $2,261 (May 8; confirmed HL vs prior LL $2,220; bullish structure developing). Recovery from $2,261 to $2,316. ~10h sideways consolidation at $2,312–2,321. 4H EMA100 est. ~$2,340 (not yet reclaimed); 4H EMA50 est. ~$2,298–2,307 (price above).
- 4H MACD: Three Python runs this session (09:11/10:09/12:08 ICT) placed MACD line in range [−3.6, +5.0]; all within [−10, +10] gate. Web aggregate (AltIndex/Investing.com) histogram est. ~−0.7 (contracting). Consensus: MACD near zero, slightly negative to slightly positive, histogram shrinking. MACD cross-of-zero not confirmed.
- 4H RSI: est. ~46–52 (neutral; web aggregates; declining from ~59 at 10:09 ICT estimate with sideways price action)
- 1H: RSI est. ~52–58 (neutral; stayed above 50 through 10h consolidation); MACD histogram est. +3 to +5 (positive; 12:08 ICT Python: line +14.6/signal +10.9/hist +3.7)
- 15m: RSI est. ~50–55 (neutral; sideways consolidation); no reversal candle at $2,316 (price mid-range, not at any support level)
- ATR(14) 1H: est. ~$11–14 (declining since May 8 LL; approx 15–17h of contraction elapsed as of 12:08 ICT; now ~22–24h elapsed — approaching or meeting 24h threshold)
- BB 4H: lower ~$2,241, mid ~$2,330, upper ~$2,419 (stabilizing after expansion; flatness not yet confirmed)
- Funding: −0.0020%/8h (negative — shorts pay longs; consistent across all session runs; structural LONG bonus)
- OI: ~$33.6B–$35.6B cross-exchange (manual verification needed; API blocked)
- L/S ratio: est. ~1.27–1.30 (56% long / 44% short; web aggregates; manual verification needed from Bybit Trading Trend)
- ETH spot ETF flows: May 1–6 cumulative ~$270M+ (confirmed); May 7–9 pending manual verification
- Whale activity: 140K–230K ETH accumulated by large wallets in prior 96h per web reports (~$322M notional; bullish signal — unverified)
- Fear & Greed Index: 11 (Extreme Fear)

**Pre-checks**:

**Multi-TF alignment (LONG)**: FAIL — price not at actionable entry point
- 4H: HL $2,261 confirmed ✓ | MACD near zero, contracting (histogram ✓ trend) | price below 4H EMA100 ($2,340) ✗ | MACD cross-of-zero unconfirmed ✗
- 1H: RSI exited <40 zone ✓ | MACD histogram positive ✓ | 15m reversal candle absent ✗ (price mid-range at $2,316, not at support — cannot form reversal entry trigger)
- 15m: RSI neutral ~50–55 ✓ | Reversal candle: ABSENT ✗ (mid-range floating; no retest of support)
- Verdict: FAIL — structural direction improving but entry timing missing

**Multi-TF alignment (SHORT)**: FAIL — 4H MACD near zero (not bearish); 1H MACD positive; RSI neutral (~52–58); no LH forming at resistance; no short alignment

**Range pre-check**: DEVELOPING (gate 1 passed 4th consecutive run; gates 2/3/4 progressing)
- Gate 1 — 4H MACD in [−10, +10]: PASS ✓ (4th consecutive hourly run passing)
- Gate 2 — ATR(14) 1H declining 24h+: BORDERLINE ✗/✓ — est. ~22–24h elapsed since May 8 LL when ATR began contracting; threshold is 24h; may have just met or still 1–2h short. If ATR contraction started at May 8 ~21:00 ICT, threshold is met at May 9 ~21:00 ICT. Treat as BORDERLINE.
- Gate 3 — horizontal range 2+ rejections each edge: FAIL ✗ — lower edge $2,265: 1 confirmed touch (May 8 LL); upper edge $2,321: 1 confirmed touch (today's 24h high); second rejection touches at each edge not yet confirmed in data
- Gate 4 — BB(20,2) 4H flat: PARTIAL ✗ — bands stabilizing but not confirmed flat; trajectory improving
- Verdict: FAIL — gate 1 continues, gate 2 borderline/approaching, gates 3/4 still developing

**News Impact Score** (window 19:14–20:14 ICT; no macro events scheduled; FOMC next June 16–17; CPI not today):

| Event | Score | Direction vs LONG |
|---|---|---|
| BNY Mellon ETH/BTC custody (Abu Dhabi ADGM launch) | 2 × 2 × 1.25 = 5.0 | Pro-LONG |
| Digital Asset Market Clarity Act push (Jul 4 target) | 2 × 3 × 1.25 = 7.5 | Pro-LONG |
| 1inch exploit $5.87M (isolated DeFi incident) | 2 × 1.5 × 1.0 = 3.0 | Against LONG |
| ETH spot ETF inflows $11.57M (May 6; trend confirm) | 2 × 1.5 × 1.25 = 3.75 | Pro-LONG |
| Morgan Stanley crypto launch on E*Trade | 2 × 2 × 1.25 = 5.0 | Pro-LONG |
| No macro event in next 1–2h | — | Clear ✓ |

Max Impact Score: 7.5 < 10 → informational only; no size reduction. No prohibitive headlines. ✓

**Prohibitive conditions (LONG)** — all checked:
- #1 (fresh daily support break): NOT triggered — $2,316 above $2,265 support ✓
- #2 (whale ratio <0.8): Likely NOT triggered — L/S est. 1.27–1.30; manual check needed ✓?
- #3 (funding strongly positive >0.025%): NOT triggered — funding −0.0020%/8h ✓
- #4 (inflow dominates): Manual verification needed; ETF data suggests exchange outflows (bullish) ✓?
- #5 (mixed-market momentum): NOT applicable ✓
- #6 (counter-trend bearish — 1D MACD <0 AND BTC <EMA200): NOT triggered — 1D MACD estimated positive; only BTC leg active; both conditions required ✓
- #7 (critical news): NOT triggered ✓

**Base conditions (LONG)** at $2,316:
- BC1 (price at strong support): FAIL ✗ — $2,316 mid-range; HL support zone at $2,261–2,287 is $29–$51 below
- BC2 (RSI 1H <40 OR RSI 4H <45): FAIL ✗ — RSI 1H ~52–58; RSI 4H ~46–52; both neutral
- BC3 (4H structure reversing — HL forming): PASS ✓ — HL $2,261 > prior LL $2,220 confirmed; bullish 4H structure developing
- BC4 (whale ratio >1.2 long): LIKELY PASS ✓ — L/S est. 1.27–1.30; manual verification needed
- BC5 (1D trend not catastrophically bearish): PASS ✓ — 1D MACD positive; Prohibitive #6 not triggered
- Score: 2–3 of 5 (BC3 confirmed + BC5 confirmed + BC4 likely; BC1 and BC2 fail). Borderline; needs manual BC4 confirmation to reach 3/5 firmly. Entry still not actionable without BC1/BC2.

**Reasoning**:
- LONG — NO_SETUP: For the 4th consecutive run, the structural picture is unchanged. The bullish thesis (HL confirmed, 1D MACD positive, funding negative, no prohibitives triggered) remains intact. However, price at $2,316 is 10 hours into a consolidation, not at an actionable support level. BC1 (price at support) and BC2 (RSI oversold) both fail. The entry trigger requires a pullback to the HL zone ($2,265–$2,290) with a 15m reversal candle. Without that, no entry. Conditions confirmed: BC3/BC5 (2 of 5). BC4 likely but unconfirmed. Max confirmed base conditions: 2 of 5, below the required ≥3 for entry.
- SHORT — NO_SETUP: No change from prior runs. 4H MACD near zero (not bearish alignment); 1H MACD positive; RSI neutral; price not at resistance with volume rejection. Short alignment fails, base conditions <2 of 5.
- RANGE — NO_SETUP: Gate 1 continues to pass (4th run). Gate 2 approaching 24h threshold (could pass by 20:00–21:00 ICT if ATR contraction holds). Gate 3 requires second edge touches — not yet observed in available data. Gate 4 stabilizing. Range setup may develop for the 21:00–22:00 ICT runs if gates 2/3/4 converge.
- Primary blocker: Price mid-range at $2,316 — not at support (BC1 fail) and RSI neutral (BC2 fail). Base conditions insufficient at 2/5. No reversal candle trigger on 15m.
- Watch for 20:00 ICT: (a) Pullback to $2,265–$2,290 + 15m reversal candle → evaluate LIVE LONG; (b) Second rejection at upper edge $2,321 → range gate 3 progressing; (c) ATR confirmed declining 24h+ → range gate 2 passes; (d) BTC crosses above EMA200 $82,128 → removes last leg of Prohibitive #6 (note: already not triggered).

**Live setup details**: N/A

**Pending order suggestion**: N/A — pending-orders.md condition 3 (structural pre-checks pass NOW) not met at current price. Pre-emptive limit at $2,278 remains WATCH scenario only; requires live 15m confirmation before placing.

**Manual verification needed before any entry**:
- Whale ratio from Bybit Trading Trend (app; est. 1.27–1.30 — unconfirmed; needed to lock in BC4)
- 15m live chart: reversal candle at support (mandatory for alignment)
- BTC price vs EMA200 on May 9 (May 6 data used; gap ~$1K; manual check needed)
- ETH spot ETF flows May 7–9 (Farside Investors / The Block)
- Exchange net inflow/outflow (Prohibitive #4; web data suggests outflows = bullish, unverified)
- ATR 1H on live chart (Python/web estimates diverge; live chart required)
- Custom trendlines on chart (trader's levels may differ from EMA-based estimates)

**Telegram sent**: no (curl returned "Host not in allowlist"; 27th consecutive run with Telegram blocked by sandbox egress; check journal directly)
...
**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist; 26th consecutive affected run). Sources: CoinMarketCap, AltIndex (technical analysis), Phemex, Yahoo Finance, MEXC, CryptoRank, SpotedCrypto, CoinLore. Indicators computed via Python from approximate 4H/1H close sequences anchored to confirmed price points (Apr 30: $2,259; May 6 HH: ~$2,400; May 8 LL: $2,261; May 9 current: ~$2,310). Precision ±5% on indicator estimates.

**Price**: $2,310 (Δ +0.9% 24h; 24h high est. ~$2,335; 24h low $2,261 [May 8 LL still holding as session floor]; vol ~$19.5B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high est. ~$2,335, low $2,261 (May 8 LL floor), vol ~$19.5B USDT
- BTC: ~$80,369 (below 1D EMA200 ~$82,128; gap ~$1,759 / ~2.2%; has not closed above EMA200 since Oct 2025)
- 4h structure: LH ($2,400, May 6) → LL ($2,261, May 8) → current bounce $2,261→$2,310 (+2.2%); bounce is potential HL forming but NOT YET CONFIRMED (no 4h candle with HL structure + volume confirmation); overall bias remains bearish LH/LL
- Indicators (1h): RSI 57.6 (neutral-bullish, recovering from LL bounce); MACD histogram turning positive (1h MACD rising toward zero as EMA12 responds faster to the bounce); EMA50 ~$2,301 (price above EMA50 on 1h — short-term bullish lean); BB Upper $2,330 / Mid $2,311 / Lower $2,291 (price near mid-band)
- Indicators (4h): RSI 50.2 (neutral); MACD near zero — borderline bearish (approx -5 to -10 estimated; histogram turning positive as bounce progresses; Gate 1 for range still holding); EMA50 ~$2,315 / EMA100 est. ~$2,340-$2,360 (above current price, acting as resistance); BB Upper $2,422 / Mid $2,333 / Lower $2,244 (wide bands, not flat — Gate 4 fail); ATR(14) ~$25
- Indicators (1D): RSI ~48-50 (neutral; recovering from ~35 at Apr 30 bottom; web aggregate: 48.58 as of today); MACD negative — below signal line, histogram negative (confirmed bearish by multiple sources); EMA200 est. ~$2,617 (price -11.7% below); all EMAs (50/100/200) above current price
- Funding: manual verification required (API blocked; no egress access)
- OI 24h change: manual verification required (API blocked)
- Top-100 L/S ratio: manual verification required (Bybit Trading Trend, no public API)

**Pre-checks**:
- Multi-TF alignment (LONG): FAIL — 4h no HL confirmed; 1D MACD <0; BTC <EMA200; 15m no reversal candle from support with volume. Additionally: Prohibitive #6 TRIGGERED → full LONG block
- Multi-TF alignment (SHORT): FAIL — 1h RSI 57.6 (not exiting >65 zone, which is required for short alignment); price at $2,310 is mid-range, not at a key resistance zone with rejection; 15m no LH + bearish reversal candle confirmed. 4h bearish structure ✓ (only 1 of 3 TF aligned)
- Range pre-check:
  - Gate 1 (4H MACD ≈ 0): PASS — 4H MACD near zero (~-5 to -10), inside [-10, +10] ✓ (5th consecutive run passing)
  - Gate 2 (ATR 1h declining 24h): PASS — ATR has been contracting since the LL at May 8; ~36h elapsed at low-volatility consolidation; 24h threshold crossed (est. ✓)
  - Gate 3 (clear horizontal range, 2 touches each edge with rejection): FAIL — Lower edge ($2,261-$2,275): confirmed 1 touch (May 8 LL); second touch not observed in available data. Upper edge (~$2,321-$2,335): 1-2 touches possible (24h high $2,335, previous run at $2,316 pulled back) but rejection candles not confirmed via web data
  - Gate 4 (BB flat on 4h): FAIL — BB Upper $2,422 vs Lower $2,244 = $178 width (~7.7% of price); bands still wide from May 6-8 volatility, not contracting to flat. Requires further consolidation
  - Range pre-check OVERALL: FAIL (Gates 3 + 4 insufficient)
- News Impact Score: estimated ~4 (Price Impact 2pt [+0.9% 24h = Minor] × Breadth 2× [cross-asset BTC+ETH macro] × Forward 1.0× [isolated/no regime change] = 4); below 10 threshold → informational, no size adjustment needed. Positive catalysts noted: ETH spot ETF inflows $11.57M May 6 (moderate); BNY Mellon digital asset custody launch (ETH+BTC); Glamsterdam hard fork targeting June 2026 (long-term bullish catalyst). Manual verification required for May 9-specific headlines.
- Prohibitive conditions (LONG): TRIGGERED — Prohibitive #6: ETH 1D MACD <0 AND BTC $80,369 < EMA200 ~$82,128 on 1D. Counter-trend bearish regime → longs not considered
- Prohibitive conditions (SHORT): PASS (none triggered; but pre-check fails, so moot)
- Prohibitive conditions (RANGE): PASS (no macro events in next 1h; news Impact <10; but range pre-check itself fails)

**Reasoning**:
- **LONG — SKIP**: Prohibitive #6 active (BTC below 1D EMA200 for 7+ months; ETH 1D MACD negative). Hard block regardless of any price action. No pending LONG per pending-orders.md rule 6.
- **SHORT — SKIP**: Multi-TF alignment fails. 1h RSI at 57.6 — not in overbought territory (need >65 exiting); price at $2,310 is mid-range, not at resistance. Only 4h structure is aligned (bearish LH/LL); 1h and 15m are NOT. Base conditions met: ≤2/5 (LH structure on 4h ✓; 1D trend non-catastrophically bullish ✓; others fail — RSI not >65, no rejection at resistance, whale ratio unverified). Minimum 3/5 required.
- **RANGE — SKIP**: Gates 1 and 2 now passing, showing range conditions are developing. But Gate 3 (second touch of each edge with rejection) and Gate 4 (BB flat on 4h) both fail. Range definition unclear without confirmed second lower-edge touch. Cannot place a range trade without clear rejection candles at both edges.
- **Primary blocker**: Prohibitive #6 (LONG) + SHORT 1h alignment (RSI 57.6, not overbought) + Range Gates 3/4 fail
- **Range development tracking** (5th run): Gate 1 ✓ Gate 2 ✓ Gate 3 ✗ Gate 4 ✗. Range conditions are maturing but the structural confirmation (second rejection touches) is not visible in aggregate data. This is the penultimate run (22:00 ICT is final).
- **Watch for final run (22:00 ICT)**: (a) Does price pull back to $2,275-$2,290 + rejection candle → lower edge second touch (Gate 3 lower edge progress); (b) Has any confirmed rejection at upper edge $2,320-$2,335 occurred today → Gate 3 upper edge; (c) If both edges confirmed with rejection + BB bands narrowing → RANGE_LONG at lower edge or RANGE_SHORT at upper edge eligible. This would be the final opportunity today (trading window closes at 22:00 ICT).

**Live setup details**: N/A

**Pending order suggestion**: N/A — Gates 3/4 not yet confirmed for range. Per pending-orders.md: structural pre-checks must PASS NOW before suggesting pending orders (condition 3). With Gate 3 failing, no pending range order is appropriate. WATCH scenario only: if 22:00 ICT run confirms both gates, evaluate RANGE at that time.

**Manual verification needed**:
- Whale ratio from Bybit Trading Trend (app; needed for BC4 confirmation on any setup)
- ETH spot ETF flows May 7-9 (Farside Investors / The Block; inflow streak continuation?)
- 15m live chart: second lower-edge rejection candle (critical for Gate 3, range setup)
- 4h BB on live chart (Python width estimate ~7.7%; live chart shows if contracting)
- BTC 1D EMA200 precise value and May 9 daily close (Prohibitive #6 gate for LONG)
- Exchange net inflow/outflow for May 9 (Prohibitive #4 context)
- Custom trendlines (trader's levels may differ from EMA-based estimates)

**Telegram sent**: no (curl returned "Host not in allowlist" — sandbox egress blocks api.telegram.org; 28th consecutive run with Telegram blocked; check journal directly)
