...
- SHORT setup structurally valid (overhead EMA cluster $2,362/$2,367 = logical entry zone, TP3 at $2,250 support = ~4.8% downside > 2.5% minimum) but requires $28–$33 rally to resistance zone first, which is contradictory in the current bearish drift
...
### 2026-05-11 18:08 ICT — auto check

**Data source**: Web aggregates (Bybit/CoinGecko/Binance APIs blocked by sandbox egress; baseline from 18:00 ICT run $2,333; 18:06–18:08 ICT web sources: TradingView $2,332.53, MetaMask $2,349.96, CoinGecko $2,322.71; consensus ~$2,335)
**Price**: $2,335 (+0.3% 24h)
**Decision**: NO_SETUP
...
| Field | Value |
|---|---|
| ETH price | ~$2,335 (flat vs $2,333 at 18:00 ICT) |
| 24h change | ~+0.3% |
| BTC price | ~$81,050 (web: $80,601–$81,259; slight recovery from $80,875 at 18:00) |
| BTC vs 1D EMA200 | $81,050 vs ~$82,127 — BELOW (~-1.3%; Prohibitive #6 active) |
| ETH 1D RSI | ~50 (neutral; unchanged) |
| ETH 1D MACD hist | ~-8.5 (negative; Prohibitive #6 condition maintained) |
| ETH 1D EMA50 | ~$2,361 (overhead resistance) |
| ETH 1D EMA200 | ~$2,367 (overhead resistance, EMA50/EMA200 cluster) |
| ETH 4h RSI | ~47 (neutral-bearish; unchanged) |
| ETH 4h MACD hist | ~-1.5 (slightly negative, contracting toward zero) |
| ETH 1h RSI | ~49 (neutral; unchanged from 18:00 run) |
| ETH 1h MACD hist | ~-0.7 (slight bearish; same as 18:00 run) |
| Funding rate | ~-0.0020% (prior run; API blocked, manual verify for update) |
| Open Interest | ~$35.6B (prior run; API blocked — manual verify for update) |
| L/S ratio | ~1.28 (prior run; API blocked — manual verify for update) |
| 1h ATR | ~$27 (estimated; no clear 24h sustained decline) |
| 4h BB | Flat; upper ~$2,420 / mid ~$2,350 / lower ~$2,280 (~6% width, not expanding) |

**Pre-checks**:
- Multi-TF alignment (LONG): FAIL — 4h MACD hist -1.5 < 0; 1h RSI 49 not in <40 demand zone; 4h LH forming (not HL)
- Multi-TF alignment (SHORT): FAIL — 1h RSI 49 far below ≥65 exit trigger; 15m data unavailable; 4h partially bearish only
- Range pre-check: FAIL — 4h MACD -1.5 (PASS, within ±10); ATR 1h declining 24h: UNCERTAIN/FAIL; defined range edges 2x-tested: FAIL (no clean bounces at current level); BB flat: PASS — 1/4 criteria met
- Macro blocker (next 1-2h): NONE — no FOMC/CPI within today's window; CPI April 2026 is May 12 @ 08:30 AM EDT = 19:30 ICT tomorrow (~25h away) → PASS for today

**Prohibitive conditions**:
- LONG #6: 1D MACD hist ~-8.5 < 0 AND BTC $81,050 < 1D EMA200 $82,127 → FIRES → ALL LONGS BLOCKED
- SHORT: no clear prohibitive fires on available data; #2/#3/#4 (whale ratio / funding / outflow) unknown — manual verification needed

**News Impact Score**:
- No prohibitive headlines (no ETH hack, no regulatory action, no macro within 1-2h)
- Headline context: (1) BTC pulled back from 200-day MA today (DailyForex "Bitcoin Pulls Back from 200", May 11 2026) — bearish confirmation; (2) whale accumulation 140K ETH in 96h — ETH-specific bullish undercurrent; (3) Glamsterdam upgrade (June 2026) not yet priced — medium-term positive catalyst
- NIS calc: 24h change +0.3% = Minor = 2 pts; Breadth = asset-specific 1.5x; Forward = isolated/confirmation 1.0x → NIS = 2 × 1.5 × 1.0 = **3.0** → informational (< 10, no size adjustment)
- FOMC: last decision April 29, rates held 3.50–3.75%; next FOMC ~June 2026 → no blocker this week

**Reasoning**:
- Conditions essentially unchanged from the 18:00 ICT run (8 minutes later; +$2 ETH, +$175 BTC; no new signals)
- Prohibitive #6 remains binding: BTC is ~$1,077 below 1D EMA200 ($82,127); for the regime to unlock, BTC needs a confirmed 1D daily close above $82,127 — earliest possible UTC midnight tonight; prior 4h BTC recovery from $80,817 to $81,050 is constructive but insufficient
- SHORT still structurally valid in principle: EMA50/EMA200 cluster at $2,361–$2,367 is logical entry zone, TP3 at ~$2,250 support = ~4.8% downside exceeds 2.5% minimum; however price remains $26–$32 below resistance with no 1h RSI exhaust approaching; setup not triggering this run
- RANGE: 4h MACD hist near zero (-1.5) is the one supportive data point for a range scenario; all other pre-checks fail; not actionable
- CPI ADVANCE NOTE: April CPI drops May 12 @ 19:30 ICT (08:30 AM EDT); the 2h pre-event macro blocker window activates at ~17:30 ICT May 12; tomorrow's runs from the 18:00 ICT slot onward will be blocked regardless of setup signals; today's 19:00, 20:00, 21:00 ICT runs are unaffected

**Watch points for 19:00 ICT**:
- SHORT trigger (low probability for next 1h): ETH rally to $2,362–$2,367 + 1h RSI exit from ≥65 + 4h LH close confirmed; price needs +$27–$32 first
- LONG UNLOCK (earliest May 12 09:00 ICT): BTC 1D close above $82,127 AND ETH 1D MACD hist turns positive
- CPI BLACKOUT TOMORROW: All setups blocked May 12 from ~17:30–18:00 ICT onward (within 2h of 19:30 ICT CPI release); today's window clear
...
### 2026-05-11 20:06 ICT — auto check

**Data source**: Web aggregates (Bybit/CoinGecko/Binance APIs blocked by sandbox egress; TradingView ETHUSDT ~$2,332.53; CoinMarketCap ~$2,345; MetaMask $2,349.96; consensus ~$2,333)
**Price**: $2,333 (+0.3% 24h)
**Decision**: NO_SETUP
...
| BTC price | ~$81,035 |
| BTC vs 1D EMA200 | $81,035 vs ~$82,127 — BELOW (~−1.3%; Prohibitive #6 active) |
| ETH 1D RSI | ~50 (neutral) |
| ETH 1D MACD hist | ~−8.5 (negative; fading from +14.2 peak at 09:01 ICT) |
| ETH 1D EMA50 | ~$2,362 (overhead resistance) |
| ETH 1D EMA200 | ~$2,367 (overhead resistance; tight cluster with EMA50) |
...
| ETH 4h EMA100 | ~$2,333 (price at) |
| ETH 1h RSI | ~49 (neutral) |
| ETH 1h MACD hist | ~−0.7 (flat-bearish; unchanged from 19:00 run) |
| Funding rate | ~−0.0020% (negative — shorts paying longs; API blocked, manual verify) |
...
| 4h BB | Upper ~$2,420 / mid ~$2,350 / lower ~$2,280 (~6% width; not expanding) |

**Pre-checks**:
- Multi-TF alignment (LONG): FAIL — 4h MACD hist −1.5 (bearish); 1h RSI ~49 (not exiting <40 demand zone); 4h LH structure active (bearish, not HL)
- Multi-TF alignment (SHORT): FAIL — 1h RSI ~49 far below ≥65 trigger; price $29–34 below resistance cluster; 15m data unavailable (API blocked)
- Range pre-check (all 4 required):
  - (1) 4h MACD hist ≤±10: ~−1.5 → PASS
  - (2) ATR(14) 1h declining 24h+: ~$27, flat-to-elevated from intraday drop at 17:00 ICT; no confirmed 24h sustained decline → FAIL
  - (3) 2x-tested horizontal range with clean edge bounces: consolidation around $2,330–$2,350 only ~3h old; no confirmed 2x clean rejections at defined edges → FAIL
  - (4) 4h BB flat: slight downward slope still present from prior-day HH rejection → FAIL
  - Score: 1/4 → RANGE pre-checks FAIL
- Macro blocker (within 1-2h): NONE — CPI May 12 @ 08:30 ET = 19:30 ICT (~23.5h away) → PASS for this run

**Prohibitive conditions**:
- LONG #6: ETH 1D MACD hist ~−8.5 < 0 AND BTC $81,035 < 1D EMA200 $82,127 → FIRES → ALL LONGS BLOCKED
- SHORT: No prohibitive condition fires; however trigger conditions not met (1h RSI ~49 far below ≥65, price not at resistance) → SHORT not triggering
- RANGE: Pre-checks fail (3/4 conditions absent) → RANGE BLOCKED

**News Impact Score**:
- No prohibitive headlines (no ETH hack, no regulatory action, no macro event within 1-2h today)
- Key catalysts identified: (1) US CPI April 2026 — May 12 @ 19:30 ICT (forward-looking; NIS clock starts tomorrow); (2) Glamsterdam hard fork June 2026 — ETH-specific forward positive; (3) Whale accumulation 140K ETH in 96h window (early May); (4) US-Iran de-escalation softening macro risk backdrop; (5) Fed Chair succession vote May 15 (Warsh nomination — forward macro positive for rate cuts)
- NIS: 24h +0.3% = minor = 2 pts; Breadth = asset-specific (Glamsterdam + ETH ETF context) = 1.5x; Forward = isolated = 1.0x → NIS = 2 × 1.5 × 1.0 = **3.0** → informational (<10, no size adjustment)
- Manual news feed verification recommended before any entry

**Reasoning**:
- Conditions essentially unchanged from 19:00 ICT run; ETH ~$12 lower vs that run, BTC ~$35 lower; no new momentum or structural shift in the 60-minute window
- Prohibitive #6 remains the binding constraint for all LONG setups: BTC at $81,035 is $1,092 (1.3%) below the 1D EMA200 ($82,127); ETH 1D MACD hist at approximately −8.5 is deeply negative; both AND-gate conditions active; regime is bearish until BTC confirms a 1D close above $82,127 AND ETH 1D MACD hist turns positive
- SHORT setup remains structurally valid in principle: 4h LH at $2,390 confirmed, overhead EMA cluster $2,362/$2,367 is the logical resistance entry zone; hypothetical SHORT from $2,362 with SL $2,407 (+45 pts) → TP1 $2,317 / TP2 $2,272 / TP3 $2,204 (6.8% potential > 2.5% minimum, R:R ~1:2.7 to TP3); 0.67 ETH at Tier 1 $30 risk; HOWEVER price is $29–34 below trigger zone with no bullish impulse approaching it; probability of triggering in today's remaining 2 slots (21:00, 22:00 ICT) is low
- RANGE: 4h MACD hist −1.5 is within ±10 (the one passing criterion); ATR, range-edge definition, and 4h BB all fail; 1/4 score; not actionable
- Pre-CPI positioning: ETH consolidating in $2,330–$2,350 band for 4+ hours; characteristic pre-event ranging; no directional conviction until CPI clears tomorrow
- Today's remaining window: 21:00 and 22:00 ICT slots are clear of the CPI blackout; however given current bearish drift and Prohibitive #6 blocking, breakeven probability of any setup in those slots is low

**Watch points for 21:00 ICT**:
- LONG UNLOCK (both required): BTC 1D close above $82,127 AND ETH 1D MACD hist turns positive; BTC ~1.3% below; no overnight catalyst visible; earliest plausible unlock = May 12 09:00 ICT after UTC midnight close
- SHORT WATCH: ETH rally to $2,362–$2,367 + 1h RSI ≥65 + 4h LH close confirmed (next local high must close < $2,390 to confirm LH vs prior HH); sideways drift makes this low-probability for today's final 2 slots
...
### 2026-05-12 09:08 ICT — auto check

**Data source**: Web aggregates (Bybit/CoinGecko/Binance APIs blocked by sandbox egress; OKX $2,330.74; CoinGecko $2,333.80; BTC OKX $81,197 / TradingView $81,962; consensus ETH ~$2,332, BTC ~$81,580)
**Price**: $2,332 (−1.1% 24h)
**Decision**: NO_SETUP
...
| ETH price | ~$2,332 |
| 24h change | −1.1% |
| 24h high / low | ~$2,379 / ~$2,320 (prior-session range; no fresh data) |
| BTC price | ~$81,580 (OKX $81,197 / TradingView $81,962) |
| BTC vs 1D EMA200 | $81,580 vs $82,127 — BELOW (−$547, −0.67%; Prohibitive #6 active) |
| ETH 1D RSI | ~50 (neutral; flat overnight) |
| ETH 1D MACD hist | ~−8.0 (negative; essentially unchanged from overnight flat) |
| ETH 1D EMA50 | ~$2,362 (overhead resistance) |
| ETH 1D EMA200 | ~$2,367 (overhead resistance; tight cluster with EMA50) |
| ETH 4h RSI | ~48 (neutral-bearish) |
| ETH 4h MACD hist | ~−1.2 (negative; converging from −1.5 prior session after 12h flat candles) |
| ETH 4h EMA100 | ~$2,333 (price at) |
| ETH 1h RSI | ~50 (neutral; converged from 49 prior session) |
| ETH 1h MACD hist | ~−0.3 (converging toward zero from −0.7 prior session after flat overnight) |
| Funding rate | ~−0.0020% (prior-session estimate; API blocked — manual verify) |
| Open Interest | ~$35.6B (prior-session estimate; API blocked) |
| L/S ratio | ~1.28 (prior-session estimate; API blocked — manual verify) |
| 1h ATR | ~$25 (down from $27; ~12h declining — 24h+ confirmation pending) |
| 4h BB | Upper ~$2,415 / mid ~$2,340 / lower ~$2,265 (~6.4% width; flat, not expanding) |

**MAJOR MACRO CATALYSTS (first run of CPI day + trade truce day)**:
- **US-China 90-day trade truce** (announced over weekend): US tariffs 145%→30%; China to 10%; S&P 500 expected +3.26% at US market open (20:30 ICT today); systemic bullish for risk assets including crypto; NIS 18.0 (see below)
- **US CPI April 2026**: scheduled 08:30 AM EDT = 19:30 ICT today; pre-release consensus: headline +3.7% YoY / +0.6% MoM, core +2.7% YoY; print not yet indexed by sources at time of this run; **macro BLACKOUT activates ~17:30 ICT** — today's 18:00, 19:00, 20:00, 21:00, 22:00 ICT runs ALL blocked by 2h pre-event rule (only 09:00–17:00 ICT runs are clean today)

**Pre-checks**:
- Multi-TF alignment (LONG): FAIL — 4h MACD hist ~−1.2 (bearish); 1h RSI ~50 (not exiting <40 demand zone); 4h structure still LH/LL with price rejecting EMA cluster overhead
- Multi-TF alignment (SHORT): FAIL — 1h RSI ~50 far below ≥65 trigger; price $30 below resistance cluster $2,362/$2,367; no overbought momentum approaching resistance
- Range pre-checks (all 4 required):
  - (1) 4h MACD hist ≤±10: ~−1.2 → PASS
  - (2) ATR(14) 1h declining 24h+: ~$25 (down from $27, ~12h trend; need 24h+ confirmed decline) → FAIL (insufficient duration)
  - (3) Horizontal range 2x-tested edges 24-48h: consolidation ~$2,320–$2,350 for ~12h only; no confirmed 2x clean rejections at defined edges → FAIL
  - (4) 4h BB flat: narrowing slightly from overnight flat but not yet clearly horizontal → FAIL
  - Score: 1/4 → RANGE pre-checks FAIL
- Macro blocker (within 1-2h): CPI at 19:30 ICT (10.4h away) → NOT ACTIVE for this run → PASS

**Prohibitive conditions**:
- LONG Prohibitive #6: ETH 1D MACD hist ~−8.0 < 0 AND BTC ~$81,580 < 1D EMA200 $82,127 → **FIRES → ALL LONGS BLOCKED**
- SHORT: No prohibitive fires; however trigger conditions not met (1h RSI ~50, price not at resistance)
- RANGE: Pre-checks fail (1/4) → BLOCKED

**News Impact Score**:
- **US-China 90-day trade truce**: ETH 24h −1.1% = Moderate (±1–3%) = 4 pts; Breadth = Systemic (macro, all risk assets) = 3×; Forward = Regime change (structural 90-day trade policy shift) = ×1.5; NIS = 4 × 3 × 1.5 = **18.0** → halve size for any SHORT that emerges (bullish news NIS 10–20 against short); extra argument for any LONG (bullish news same direction); note: LONG still blocked by Prohibitive #6 regardless
- **CPI (April 2026)**: releasing today at 19:30 ICT; pre-event blackout from ~17:30 ICT; not scored yet (print unknown at time of this run); will be incorporated in later entries if runs are not blackout-blocked
- No prohibitive headlines: no ETH hack, no regulatory action, no FOMC within 1-2h today

**Reasoning**:
- First run of May 12 — highest macro-catalyst density of the paper-trading test so far (CPI day AND trade truce day)
- Despite the US-China trade truce being a regime-change macro catalyst (NIS 18.0, S&P expected +3.26%), ETH has not moved materially overnight: ~$2,332 vs May 11 close ~$2,333. This suggests crypto has either already partially digested the news or is waiting for US equity confirmation at 20:30 ICT (inside the CPI blackout window)
- Prohibitive #6 remains the dominant binding constraint: BTC at $81,580 is $547 (0.67%) below the 1D EMA200 ($82,127); ETH 1D MACD hist at ~−8.0 is deeply negative. Both AND-gate conditions active. Note: The trade truce could push BTC above $82,127 today when US markets open at 20:30 ICT, but this falls inside the CPI blackout window — even if BTC breaks above EMA200, runs from 18:00 ICT are already blocked. The LONG regime unlock will be assessable at tomorrow's 09:00 ICT run (May 13) after tonight's 1D close
- SHORT structurally valid in principle: EMA50/EMA200 cluster at $2,362/$2,367 is the resistance entry zone; hypothetical SHORT from $2,362 SL $2,407 (+45 pts) → TP1 $2,317 / TP2 $2,272 / TP3 $2,204 (6.8% potential > 2.5% minimum); HOWEVER trade truce NIS 18.0 (bullish, against short) would require halving position to ~0.33 ETH at Tier 1; plus price is $30 below trigger zone with no upward momentum; SHORT not triggering today
- RANGE: Only 1/4 pre-check passes; not actionable
- Today's effective run schedule: 09:00, 10:00, 11:00, 12:00, 13:00, 14:00, 15:00, 16:00, 17:00 ICT clean (9 runs); 18:00–22:00 ICT ALL BLOCKED by CPI 2h pre-event macro blackout

**Watch points for next check (10:00 ICT)**:
- Monitor BTC price action: a push through $82,127 (currently $547 away) would be bullish structural signal; watch hourly closes
- ETH 1D MACD recovery timeline: even after BTC breaks EMA200, ETH MACD hist needs multiple bullish daily candles to recover from −8.0 to 0; LONG regime unlock requires BOTH conditions → expect earliest LONG eligibility at May 13+ morning run if overnight BTC closes above EMA200
- SHORT WATCH: ETH rally to $2,362–$2,367 + 1h RSI ≥65 + 4h LH confirmation; trade truce tailwind makes sustained SHORT less compelling but structurally valid if price reaches resistance; NIS-adjusted size would be ~0.33 ETH (halved from 0.67 ETH)
- CPI BLACKOUT REMINDER: All setups blocked today from 17:30 ICT (Macro headline rule); first clean post-CPI run is tomorrow 09:00 ICT May 13
