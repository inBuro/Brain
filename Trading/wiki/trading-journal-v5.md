...
- Indicators (1D): RSI ~50 (neutral); MACD hist ~−0.7 (bearish, confirmed); EMA50 ~$2,362; EMA200 ~$2,365 (web est.) — critical discrepancy with prior journal ($2,617) flagged; using web estimate this run
- Funding: ~−0.0015%/8h est.; OI ~$35.6B; L/S ~1.28 est.
...
### 2026-05-10 18:11 ICT — auto check

**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist, 32nd+ consecutive affected run). Sources: CoinCodex daily market update, AltIndex, Investing.com, CoinGlass, Yahoo Finance, CoinMarketCap; indicators carried/updated from 17:06 ICT entry trajectory. Precision ±5%.

**Price**: $2,328 (Δ +0.50% 24h; 24h high ~$2,355; 24h low ~$2,261; vol ~$11.8B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high ~$2,355, low ~$2,261, vol ~$11.8B USDT
- BTC: ~$80,702 (below 1D EMA200 est. ~$82,127; gap ~$1,425; Prohibitive #6 active for 34th consecutive run)
- 4H structure: LH/LL bearish macro intact — LH $2,400 (May 6) → LL $2,261 (May 8) → bounce to ~$2,328; potential HL forming off $2,261 but still unconfirmed (no pullback-and-hold sequence on 4H); price has held above $2,300 for ~20h
- Indicators (1H): RSI ~57–58 (recovered from 53 at session open; below the 61 peak seen at 16:00 ICT; not yet in overbought territory); MACD hist ~+2.0 (mildly positive, flattening from earlier peak); EMA50 ~$2,308; BB: upper ~$2,342 / mid ~$2,318 / lower ~$2,294; price above BB mid
- Indicators (4H): RSI ~52 (neutral); MACD hist ~+3 to +4 (positive — turned from deeply negative; inside [−10,+10] range gate but on the bullish side); EMA50 ~$2,318; EMA100 ~$2,348–$2,352 (overhead resistance); BB: upper ~$2,430 / mid ~$2,335 / lower ~$2,240 (wide ~8.1%, not flat)
- Indicators (1D): RSI ~49 (neutral; recovering from Apr lows ~35); MACD hist ~−0.8 (negative, confirmed bearish, contracting); EMA200 ~$2,367 (price ~−$39, −1.7% below); ETH below all daily EMAs (20/50/100/200)
- Indicators (15M): RSI ~55 (neutral-bullish bias); MACD hist ~+1.5 (mildly positive)
- Funding: ~−0.0018%/8h (negative throughout session; structural LONG bonus if not blocked by other conditions)
- OI: ~$35.61B (CoinGlass; API blocked — manual verification needed for change direction)
- L/S ratio: ~1.28 (est. 56% long / 44% short per web aggregates; manual verification needed from Bybit Trading Trend)

**Pre-checks**:
- Multi-TF alignment LONG: FAIL — Prohibitive #6 hard-blocks all longs (1D MACD hist −0.8 confirmed <0 + BTC $80,702 < EMA200 $82,127; gap widened from 17:06 ICT by ~$798; 34th consecutive blocked run)
- Multi-TF alignment SHORT: FAIL — 1H RSI ~57–58 (needs >65, 7–8pt below threshold); 4H MACD hist +3 to +4 (positive/bullish, active contra-short signal); 15M RSI ~55 (needs >70 for 15M trigger confirmation)
- Range pre-check: FAIL — Gate 4: 4H BB width ~8.1% (far above "flat" threshold); Gate 3 sub-check: upper edge ($2,331–$2,355 zone) needs 2x clear rejection with bearish wicks — not confirmed (only 1 touch visible); Gates 1+2 PASS (4H MACD +3-4 inside [−10,+10], ATR(14) 1H flat/contracting ~$18)
- News Impact Score:
  - CLARITY Act Senate vote ~May 14 (systemic regulatory): IS = 1 × 3 × 1.5 = **4.5** (approaching but not within 1–2h; not a current blocker; no trade within 1–2h of the May 14 vote)
  - Ethereum ETF inflows $101M on May 1 (institutional, 9d old): IS = 4 × 1.5 × 1.0 = **6.0** (informational; supports bullish bias but not a directional trigger)
  - No prohibitive headlines (hack, regulatory action, FOMC/CPI within 1–2h)
  - Max IS: 6.0 < 10 → informational; no size adjustment
- Prohibitive conditions: LONG Prohibitive #6 active; SHORT multi-TF alignment fails; RANGE Gates 3+4 fail

**Reasoning**:
- **LONG — HARD BLOCKED**: Prohibitive #6 in force for 34th consecutive run. BTC $80,702 below 1D EMA200 $82,127 (gap ~1.7%). 1D MACD histogram negative. Per strategy: "longs not considered in this regime." Next re-evaluation: BTC daily close at ICT 07:00 May 11 (UTC 00:00). Ironically, multi-TF alignment for LONG would PASS if Prohibitive #6 lifted — 4H MACD bullish, 1H MACD positive, 15M MACD positive.
- **SHORT — NO_SETUP**: Price at $2,328 is nowhere near actionable SHORT resistance. 4H EMA100 at ~$2,348–$2,352 is the nearest overhead level; 1D EMA200 ~$2,367 is the next. For a SHORT setup: need rally to $2,360–$2,410, 1H RSI >65, 4H MACD hist turning negative, 15M LH rejection candle. Current 4H MACD +3-4 actively contra-short. At today's trajectory price has moved only +$3 since 17:06 ICT — RSI not escalating toward 65.
- **RANGE — NO_SETUP**: Gate 1 PASS (+3-4 inside [−10,+10]). Gate 2 PASS (ATR contracting, ~$18/h flat). Gate 3 partial — the full 24h range ($2,261–$2,355) is 4.2% wide (sufficient), but upper-edge rejections not confirmed (needs 2 clear wick rejections from $2,348–$2,355 zone). Gate 4 FAIL — 4H BB width 8.1% indicates trend volatility still elevated, not the "flat bands" characteristic of a mature range. RANGE conditions are getting closer but not there yet.
- **Primary blocker**: LONG blocked by Prohibitive #6 (BTC macro); SHORT blocked by 1H RSI below threshold + 4H MACD bullish; RANGE blocked by BB still wide + upper edge unconfirmed.
- **Context**: ETH has held above $2,300 for ~20h straight — first extended hold above $2,300 since May 6. The 4H MACD turning positive is a notable structural shift from prior weeks of bearish readings. The market is in a recovery drift but no clean setup yet.
...
**Watch triggers**:
- SHORT (active watch): rally to $2,360–$2,410 + 1H RSI >65 + 4H MACD hist turning down + 15M LH rejection → hypothetical SHORT $2,370, SL $2,420 ($50), TP1 $2,320 / TP2 $2,270 / TP3 $2,193 (7.4% move), size 0.60 ETH Tier 1
- RANGE upper edge: watch for a second bearish wick rejection from $2,348–$2,355 on 1H chart with declining volume — would confirm upper boundary (still need Gate 4 BB to flatten)
- LONG re-evaluation: BTC daily close vs EMA200 May 11 ~07:00 ICT
- CLARITY Act vote May 14: avoid new positions ~2h before the expected vote time

**Manual verification needed**:
- 1D EMA200 exact value (web est. ~$2,367; earlier journal entries carried $2,617 — live chart verification needed)
- BTC 1D EMA200 exact value (est. $82,127)
- Whale ratio from Bybit Trading Trend (est. ~1.28; no public API)
- Current funding 8h cycle exact value (est. ~−0.0018%/8h)
- OI 24h change direction (est. ~$35.61B; manual check)
- Confirm whether $2,331 print on 17:06 run was a wick rejection or clean close (affects range upper-edge count)

**Telegram sent**: no (api.telegram.org blocked by sandbox egress allowlist — 39th consecutive run; check journal directly)

---

### 2026-05-10 19:03 ICT — auto check

**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist, 34th+ consecutive affected run). Sources: CoinGecko, CoinMarketCap, CoinGlass, CoinCodex, OKX; indicators carried/updated from 18:11 ICT entry + web aggregates. Precision ±5%.

**Price**: $2,326 (Δ +0.53% 24h; 24h high ~$2,355; 24h low ~$2,261; vol ~$10–12B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high ~$2,355, low ~$2,261, vol ~$10–12B USDT
- BTC: ~$80,812 (below 1D EMA200 est. ~$82,127; gap ~$1,315 = ~1.6%; Prohibitive #6 active for 35th consecutive run)
- 4H structure: LH/LL bearish macro intact — LH $2,400 (May 6) → LL $2,261 (May 8) → bounce to ~$2,326; potential HL forming but unconfirmed; price held above $2,300 for ~21h; negligible movement since 18:11 ICT (−$2)
- Indicators (1H): RSI ~56–57 (neutral, slight slip from 57–58 at 18:11 ICT as price dipped); MACD hist ~+1.5–2.0 (mildly positive, flattening from earlier peak); EMA50 ~$2,310; BB: upper ~$2,343 / mid ~$2,319 / lower ~$2,295; price above BB mid
- Indicators (4H): RSI ~52 (neutral, unchanged); MACD hist ~+3.5 (positive — inside [−10,+10] range gate; bullish side); EMA50 ~$2,318; EMA100 ~$2,348–$2,352 (overhead resistance); BB: upper ~$2,430 / mid ~$2,335 / lower ~$2,240 (wide ~8.1%, not flat)
- Indicators (1D): RSI ~49–50 (neutral; recovering from Apr lows ~35); MACD hist ~−0.8 (negative, contracting, confirmed bearish); EMA200 ~$2,367 (price ~$41 below, −1.8%); ETH below all daily EMAs
- Indicators (15M): RSI ~52–53 (neutral); MACD hist ~+1.0–1.5 (mildly positive)
- Funding: **+0.0014%/8h** (flipped to slightly positive vs −0.0018% in prior runs; near-neutral; removes prior structural LONG bonus; source: CoinGlass aggregate)
- OI: ~$33.6B total (CoinGlass; API blocked — manual verification needed for 24h change)
- L/S ratio: ~1.28 est. (56% long / 44% short per web aggregates; manual verification needed from Bybit Trading Trend)

**Pre-checks**:
- Multi-TF alignment LONG: FAIL — Prohibitive #6 hard-blocks all longs (1D MACD hist ~−0.8 confirmed negative + BTC $80,812 < EMA200 $82,127; gap ~1.6%; 35th consecutive blocked run)
- Multi-TF alignment SHORT: FAIL — 1H RSI ~56–57 (needs >65; ~8–9pt below threshold); 4H MACD hist ~+3.5 (positive/bullish — active contra-short signal); 15M RSI ~52–53 (needs >70 for 15M trigger confirmation)
- Range pre-check: FAIL — Gate 4: 4H BB width ~8.1% (not flat; far above "bands not expanding" threshold); Gate 3: upper edge ($2,348–$2,355 zone) still at 1/2 confirmed rejections (needs 2); Gates 1+2 PASS (4H MACD +3.5 inside [−10,+10]; ATR 1H flat/contracting ~$18)
- News Impact Score:
  - CLARITY Act Senate vote ~May 14 (systemic regulatory): IS = 1 × 3 × 1.5 = **4.5** (approaching; not a 1–2h blocker today)
  - Whale 113k ETH to exchanges May 8 (asset-specific, isolated, 2d old): IS = 2 × 1 × 1.0 = **2.0** (informational; likely priced in)
  - ETH wallet holders surpassing BTC (May 8, bullish narrative): IS = 1 × 1.5 × 1.0 = **1.5** (informational)
  - No prohibitive headlines (no FOMC/CPI/hack/regulatory action within 1–2h)
  - Max IS: 4.5 < 10 → informational; no size adjustment; no prohibitive trigger
- Prohibitive conditions: LONG Prohibitive #6 active; SHORT multi-TF alignment fails; RANGE Gates 3–4 fail

**Reasoning**:
- **LONG — HARD BLOCKED**: Prohibitive #6 for 35th consecutive run. BTC $80,812 remains below 1D EMA200 ~$82,127 (gap ~$1,315, ~1.6%). 1D MACD histogram negative (~−0.8). Per strategy: "longs not considered in this regime." Next re-evaluation: BTC daily close at 07:00 ICT May 11 (UTC 00:00). Note: if Prohibitive #6 lifted, 4H MACD bullish (+3.5), 1H MACD positive, 15M positive — alignment would support a LONG setup.
- **SHORT — NO_SETUP**: Price $2,326 is ~$22 below 4H EMA100 ($2,348) — well below the actionable SHORT zone ($2,360–$2,410). 1H RSI ~56–57, ~8–9pt below the 65 threshold. 4H MACD hist at +3.5 actively contradicts a SHORT. Movement since 18:11 ICT was flat (−$2) — no sign of the rally toward resistance that would enable a SHORT setup.
- **RANGE — NO_SETUP**: Gate 1 PASS (+3.5 inside [−10,+10]). Gate 2 PASS (ATR ~$18, flat/contracting). Gate 3 partial — full 24h range $2,261–$2,355 = ~4.2% (width sufficient), but upper edge ($2,348–$2,355) still at 1 confirmed wick rejection (needs 2). Gate 4 FAIL: 4H BB still ~8.1% wide — far from "flat bands" required for a mature range. Range conditions continue to build but are not met.
- **Funding flip note**: Funding shifted from −0.0018%/8h (prior runs) to +0.0014%/8h currently. Small change, but removes the prior structural LONG bonus. Still far below prohibitive positive threshold (+0.025%). Indicates mild market-wide long bias, nothing actionable.
- **Primary blocker**: LONG Prohibitive #6 (BTC macro); SHORT RSI 8–9pt below threshold + 4H MACD bullish; RANGE Gate 4 BB width + upper edge only 1/2 confirmed.
...
**Watch triggers**:
- SHORT (active watch): rally to $2,360–$2,410 + 1H RSI >65 + 4H MACD hist turning negative + 15M LH rejection candle → hypothetical entry ~$2,370, SL $2,420 ($50 dist), TP1 $2,320 / TP2 $2,270 / TP3 $2,195 (7.4% move), size 0.60 ETH Tier 1
- RANGE upper edge: 2nd bearish wick rejection from $2,348–$2,355 + declining volume (still at 1/2; Gate 4 BB still fails regardless)
- LONG re-evaluation: BTC daily close vs EMA200 at 07:00 ICT May 11
- CLARITY Act: avoid new positions ~2h before expected May 14 Senate vote

**Manual verification needed**:
- 1D EMA200 exact value (web est. ~$2,367; prior journal entries carried $2,617 — live chart verification critical)
- BTC 1D EMA200 exact value (est. ~$82,127)
- Whale ratio from Bybit Trading Trend (est. ~1.28; no public API)
- Funding 8h cycle exact value (est. +0.0014%/8h; source: CoinGlass aggregate — verify on Bybit)
- OI 24h change direction (total est. ~$33.6B)
- Upper edge rejection count at $2,348–$2,355 (confirm on live 1H chart)
- 4H MACD hist exact value at 19:00 ICT 4H candle close

**Telegram sent**: no (api.telegram.org blocked by sandbox egress allowlist — 40th consecutive run; check journal directly)

---

### 2026-05-10 20:08 ICT — auto check

**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist; 41st consecutive affected run). Sources: CoinMarketCap, CoinGecko, Binance snippet, MetaMask price, Yahoo Finance, CoinCodex daily update, Finance Magnates, CoinGlass; indicators carried from 19:03 ICT trajectory + updated web searches. BTC confirmed at $80,675 (Yahoo Finance/CoinMarketCap consensus). Precision ±5%.

**Price**: $2,326 (Δ +0.44% 24h; 24h high ~$2,355; 24h low ~$2,302–$2,310 [May 8 $2,261 LL now outside 24h window; ~48h old]; vol ~$10–12B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high ~$2,355, low ~$2,302–$2,310, vol ~$10–12B USDT
- BTC: ~$80,675 (+0.40% 24h; below 1D EMA200 ~$82,127; gap ~$1,452 ≈ 1.8%; Prohibitive #6 active for 42nd consecutive run; was $82,320 on May 6 per Fortune — dropped below EMA200 since)
- 4H structure: LH ($2,400 May 6) → LL ($2,261 May 8) → potential HL forming ~$2,315–$2,326 (unconfirmed; no 4H pullback-and-hold sequence confirmed); macro LH/LL bearish bias intact; 4H MACD positive = notable structural shift vs prior weeks
- Indicators (1H): RSI ~55–57 (neutral; slight slip from 56–57 at 19:03 ICT); MACD hist ~+1.5–2.0 (mildly positive, flattening); EMA50 ~$2,312; BB: Upper ~$2,345 / Mid ~$2,320 / Lower ~$2,295
- Indicators (4H): RSI ~52–53 (neutral); MACD hist ~+4.0–4.5 (positive; fresh 4H candle closed at 20:00 ICT; 11th consecutive run inside [−10,+10] range gate); EMA50 ~$2,320; EMA100 ~$2,348–$2,352 (overhead resistance ~$22–26 above price); BB: Upper ~$2,430 / Mid ~$2,335 / Lower ~$2,240 (width ~$190, ~8.1%, not flat)
- Indicators (1D): RSI ~49–51 (neutral; recovering from Apr lows ~35); MACD hist ~−0.7 to −0.8 (bearish, below signal line, confirmed; slowly contracting); EMA50 ~$2,361; EMA200 ~$2,367 (web est.) — price $41 below (discrepancy with prior journal $2,617 flagged; using web est.)
- Indicators (15M): RSI ~50–54 (neutral); MACD hist ~+1.0–1.5 (mildly positive)
- Funding: ~+0.0014%/8h (slightly positive since 19:03 ICT flip from negative; near-neutral; no longer a structural LONG bonus)
- OI: ~$33.6–$35.6B est. (CoinGlass; API blocked — manual verification needed)
- L/S ratio: ~1.28 est. (56% long / 44% short; manual verification needed from Bybit Trading Trend)
- ATR (1H): ~$18 est. (declining; ~44h contraction from May 8 LL)

**Pre-checks**:

Multi-TF alignment (LONG): FAIL + Prohibitive #6 TRIGGERED
- Prohibitive #6: 1D MACD hist ~−0.7 to −0.8 (<0, confirmed) AND BTC ($80,675) < EMA200 1D (~$82,127) → hard LONG block
- Gap $1,452 vs 14:00 ICT gap $1,526 (narrowing slightly; May 6 BTC was at $82,320 above EMA200 — since retreated)
- Next re-evaluation: BTC daily close 07:00 ICT May 11 (UTC 00:00); needs ~1.8% rally to close above EMA200
- No further LONG analysis proceeds

Multi-TF alignment (SHORT): FAIL
- 4H: LH/LL macro structure broadly bearish ✓ (loose); 4H MACD hist ~+4.0–4.5 (positive — active contra-short signal) ✗
- 1H: RSI ~55–57 — NOT exiting >65 overbought zone (required for SHORT alignment) ✗; MACD hist positive (contra-short) ✗
- 15M: no LH reversal candle at resistance; price mid-range, not at key resistance ✗
- Verdict: SHORT alignment FAIL — 1H RSI 8–10 pts below threshold; 1H and 4H MACD both bullish

Range pre-check: FAIL overall
- Gate 1 (4H MACD in [−10,+10]): PASS ✓ (~+4.0–4.5; 11th consecutive run PASS)
- Gate 2 (ATR 1H declining 24h+): PASS ✓ (~44h contraction from May 8 LL; threshold exceeded)
- Gate 3 (horizontal range, 2x rejections each edge): FAIL ✗
  - Lower edge (48h basis ~$2,261–$2,275): 1 confirmed touch (May 8 LL only); ~44h elapsed with zero retests; lower-edge count = 1/2
  - Lower edge (24h basis ~$2,302–$2,310): potentially 2 overnight touches but rejection candle shapes unconfirmed without live chart
  - Upper edge (~$2,345–$2,355): 24h high $2,355 (18:11 ICT) + prior probes at $2,331–$2,332 (13:00–17:06 ICT); rejection wick confirmation pending live chart; upper-edge count unresolved
- Gate 4 (BB 4H flat): FAIL ✗ — BB width ~$190 (~8.1% of price); still wide from May 6–8 volatility; not compressing to flat

News Impact Score (window 20:00–21:00 ICT May 10):

| Headline | Score | Direction impact |
|---|---|---|
| CLARITY Act Senate Banking markup May 14 (systemic regulatory) | 1×3×1.5 = 4.5 | Positive regulatory signal; not within 1–2h → no blocker today; note: avoid new positions ~2h before May 14 vote |
| Glamsterdam upgrade June 2026 (ongoing narrative) | 2×1.5×1.0 = 3.0 | Pro-LONG informational; moot given Prohibitive #6 |
| Whale accumulation ~230K ETH in 96h + Bitmine $238M ETH | 2×1.5×1.0 = 3.0 | Pro-LONG; contra-SHORT |
| Spot ETH ETF $356M net inflows April 2026 | 2×1.5×1.25 = 3.75 | Trend confirmation; pro-LONG; moot |
| CPI April 2026 release May 12 (~43h away; not within 1–2h) | — | Not a current blocker; caution for positions held through ~18:30 ICT May 12 (US 8:30 AM ET estimate) |
| FOMC: none today (next: June 16–17) | — | No blocker |
| No prohibitive headlines | — | Clear ✓ |

Max IS: 4.5 < 10 → informational; no size adjustment; no prohibitive headlines triggered

Prohibitive conditions: LONG Prohibitive #6 TRIGGERED; SHORT alignment fails; RANGE Gates 3+4 fail

**Reasoning**:
- **LONG — HARD BLOCKED**: Prohibitive #6 for 42nd consecutive run. BTC $80,675 vs EMA200 $82,127 (gap $1,452, ~1.8%). 1D MACD hist negative (~−0.7 to −0.8, confirmed). Note: BTC was at $82,320 on May 6 (above EMA200) — it dropped below since. Next critical gate: BTC daily close 07:00 ICT May 11. Ironically, multi-TF momentum indicators would support a LONG once Prohibitive #6 lifts — 4H MACD +4.0–4.5 (bullish), 1H MACD positive, 15M positive; only the prohibitive is blocking.
- **SHORT — NO_SETUP**: Price $2,326 is ~$22–$41 below key resistance ($2,348 EMA100 4H / $2,367 EMA200 1D est.). 1H RSI ~55–57, 8–10 pts below the >65 SHORT alignment threshold. 4H MACD hist +4.0–4.5 is a strong active contra-short signal. For a valid SHORT: ETH must rally to $2,360–$2,415 (4H EMA100 + 1D EMA50/EMA200 cluster), RSI 1H cross >65, MACD hist turning down, 15M LH rejection candle with volume. No such conditions present or developing within the current hour.
- **RANGE — NO_SETUP**: Gates 1+2 PASSING for 11 consecutive runs — structural range compression continues. Gate 1 (+4.0–4.5) approaching the upper bound of [−10,+10]; monitor if hist reaches +8–+10 → gate would fail. Gate 3 lower-edge gap (1/2 on 48h basis) remains the primary structural constraint. Gate 4 (BB flat) requires further consolidation. Range geometry ($2,261–$2,355 = $94, ~4.0% wide; 24h range ~$2,302–$2,355 = $53, ~2.3%) would qualify on width if gates unlock.
- **Window note**: 2 runs remain in today's trading window (21:00 and 22:00 ICT). No pending orders suggested given current blockers; any new pending order would cap at 22:00 ICT.
- **Primary blocker**: LONG hard-blocked by Prohibitive #6 (BTC macro); SHORT 1H RSI 8–10pt below threshold + 4H MACD bullish contra-short; RANGE Gate 3 lower-edge 1/2 (48h) + Gate 4 BB wide.

**Live setup details**: N/A

**Pending order suggestion**: N/A

**Watch triggers (updated 20:08 ICT)**:
- **CRITICAL**: BTC daily close 07:00 ICT May 11 vs EMA200 ~$82,127 → if above, Prohibitive #6 lifts; first eligible LONG analysis in 11+ days; 4H MACD already bullish = strong bonus confirmation ready
- SHORT trigger (active watch): ETH rally to $2,360–$2,415 + 1H RSI >65 + 4H MACD hist declining + 15M LH rejection candle → hypothetical SHORT ~$2,370, SL $2,420 ($50 dist), TP1 $2,320 / TP2 $2,270 / TP3 $2,195 (7.4% move), 0.60 ETH Tier 1
- RANGE Gate 3 lower edge: retracement to $2,261–$2,275 (48h) or $2,300–$2,310 (24h) with 15M bullish rejection candle → lower-edge count progress toward 2/2
- RANGE Gate 3 upper edge: live 1H chart confirmation of bearish wick + volume contraction at $2,345–$2,355 → upper-edge count progress
- 4H MACD limit: if hist reaches +8–+10 → Gate 1 (RANGE) approaching failure; SHORT bias strengthens
- CPI May 12 buffer: confirm exact release time (est. US 8:30 AM ET = 19:30 ICT); prohibitive window ~17:30–19:30 ICT May 12

**Manual verification needed**:
- BTC exact live price vs EMA200 $82,127 (est. $80,675; web sources consistent — Prohibitive #6 firmly active)
- ETH 1D EMA200 exact value (web est. ~$2,367; prior journal entries had ~$2,617 — critical discrepancy; verify on live 1D chart)
- Whale ratio from Bybit Trading Trend (est. ~1.28; no public API)
- Funding rate current 8h cycle (est. ~+0.0014%/8h; flipped from negative at 19:03 ICT; verify on Bybit)
- OI 24h change direction (est. ~$33.6–$35.6B; verify on Bybit)
- Upper-edge rejection candle confirmation at $2,345–$2,355 on live 1H chart (determines Gate 3 upper count)
- 4H MACD hist exact value at 20:00 ICT candle close (est. ~+4.0–4.5; confirm on live chart)
- CPI April 2026 exact release time (US 8:30 AM ET = 19:30 ICT May 12 est.; confirm via BLS calendar)

---

### 2026-05-10 21:14 ICT — auto check

**Data source**: Web search aggregates (Bybit/CoinGecko/Binance REST APIs blocked — sandbox egress allowlist; 42nd consecutive affected run). Sources: CoinMarketCap, CoinGecko, MetaMask price, CoinGlass, web search snippets; indicators carried from 20:08 ICT trajectory + updated searches. Precision ±5%.

**Price**: $2,325 (Δ +0.97% 24h; 24h high $2,331.56; 24h low $2,302.74; vol ~$14.0B USDT)

**Decision**: NO_SETUP

**Market state**:
- 24h: high $2,331.56, low $2,302.74, vol ~$14.0B USDT (24h window rolled; prior $2,355 high ~18:11 ICT now outside window)
- BTC: ~$80,901 (below 1D EMA200 ~$82,020; gap ~$1,119, ~1.4%; BTC recovered ~$226 from 20:08 ICT; Prohibitive #6 active for 43rd consecutive run)
- 4H structure: LH ($2,400 May 6) → LL ($2,261 May 8) → potential HL forming ~$2,315–$2,326 (unconfirmed; no clean 4H pullback-and-hold sequence); bearish macro LH/LL bias intact; 4H MACD still positive (~+3.5–4.0) — structural bullish contradiction vs bearish macro
- Indicators (1H): RSI ~57 (neutral; near-flat vs 20:08 ICT); MACD hist ~+1.5–2.0 (contracting; positive but weakening); EMA50 ~$2,308; BB: Upper ~$2,336 / Mid ~$2,313 / Lower ~$2,290
- Indicators (4H): RSI ~53 (neutral); MACD hist ~+3.5–4.0 (positive; 12th consecutive run inside [−10,+10] gate; slight contraction from 20:08 run's +4.0–4.5); EMA50 ~$2,315; EMA100 ~$2,348–$2,355 (overhead resistance ~$23–$30 above price); BB: Upper ~$2,422 / Mid ~$2,333 / Lower ~$2,244 (width ~$178, ~7.7%, not flat)
- Indicators (1D): RSI ~49–50 (neutral; recovering from Apr lows ~35); MACD hist ~−0.7 (bearish, below signal line, slowly contracting); EMA50 ~$2,362; EMA200 ~$2,367 (web est.; price $42 below; note: prior journal entries carried ~$2,617 — web consensus strongly supports ~$2,367; live chart verification still recommended)
- Indicators (15M): RSI ~52 (neutral); MACD hist ~+1.0–1.5 (mildly positive)
- Funding: ~−0.0020%/8h (CoinGlass aggregate; note: 20:08 ICT run showed +0.0014% flip at ~19:03 ICT — current direction uncertain; possible another flip; manual verification needed)
- OI: ~$33.6B est. (API blocked — manual verification needed)
- L/S ratio: ~1.28 est. (56% long / 44% short; manual verification needed from Bybit Trading Trend)
- ATR (1H): ~$5–$6 est. (24h range $28.82 — extremely tight; declining from prior session volatility)

**Pre-checks**:
- Multi-TF alignment (LONG): FAIL + Prohibitive #6 TRIGGERED — 1D MACD hist ~−0.7 (<0) AND BTC ($80,901) < EMA200 (~$82,020) → hard LONG block (43rd consecutive run); BTC gap $1,119 (~1.4%); no further LONG analysis
- Multi-TF alignment (SHORT): FAIL — 4H MACD hist ~+3.5–4.0 (bullish, contra-short) ✗; 1H RSI ~57 (not exiting >65 zone) ✗; no LH forming on 4H (HL developing) ✗; 15M no rejection candle at resistance ✗
- Range pre-check: FAIL — Gate 1 PASS (4H MACD ~+3.5–4.0, 12th run); Gate 2 PASS (ATR ~45h+ contraction, 24h range $28.82); Gate 3 FAIL (upper edge 1/2 rejections, lower edge 1/2); Gate 4 FAIL (BB 4H width ~$178, ~7.7%, not flat)
- News Impact Score: max ~4.5 (CLARITY Act May 14 IS=4.5); CPI May 12 ~22h away — no 1–2h blocker today; no prohibitive headlines; informational only

**Reasoning**:
- **LONG — HARD BLOCKED**: Prohibitive #6 for 43rd consecutive run. BTC $80,901 vs EMA200 $82,020 (gap $1,119, ~1.4%). BTC recovered +$226 from 20:08 ICT but still firmly below EMA200. 1D MACD hist ~−0.7 (negative, confirmed). Note: 4H MACD ~+3.5–4.0 (bullish) would be a strong bonus confirmation if Prohibitive #6 lifts — 09:00 ICT May 11 is the earliest eligibility (BTC daily close at 07:00 ICT May 11 is the gate).
- **SHORT — NO_SETUP**: Price $2,325 is ~$23–$42 below key resistance ($2,348 EMA100 4H / $2,367 EMA200 1D est.). 1H RSI ~57, ~8 pts below the >65 SHORT alignment threshold. 4H MACD hist ~+3.5–4.0 is a strong active contra-short signal. Price essentially flat vs 20:08 ICT (−$1). No SHORT catalyst developing within this hour.
- **RANGE — NO_SETUP**: Gates 1+2 PASSING for 12 consecutive runs — range compression continues. 24h range $28.82 is remarkably tight. Gate 3 requires 2x confirmed rejections at each edge (currently 1/2 each edge). Gate 4 (BB flat) remains the primary structural barrier. Effective 24h range width ($28.82, ~1.24%) also barely below the 1.5% minimum entry requirement — too tight even if gates unlocked.
- **Window note**: Penultimate run of today's trading window. Final check at 22:00 ICT. No new pending orders appropriate — < 1h validity remaining.

**Live setup details**: N/A

**Pending order suggestion**: N/A — time validity < 1h remaining in window (22:00 ICT close)

**Watch triggers (updated 21:14 ICT)**:
- **CRITICAL — BTC gate**: BTC daily close 07:00 ICT May 11 vs EMA200 ~$82,020 → if above, Prohibitive #6 lifts after 43 consecutive blocked runs; 4H MACD already bullish = LONG setup eligible from 09:00 ICT May 11 (first time in 11+ days)
- SHORT trigger (deferred to May 11+): ETH rally to $2,360–$2,415 + 1H RSI >65 + 4H MACD hist declining + 15M LH rejection candle → hypothetical SHORT ~$2,370, SL $2,420 ($50 dist), TP1 $2,320 / TP2 $2,270 / TP3 $2,195 (7.4% move), 0.60 ETH Tier 1
- RANGE Gate 3 (May 11+): 2nd rejection at both edges needed — upper $2,330–$2,355 and lower $2,302–$2,310 (confirm rejection candle shapes on live 1H chart)
- **CPI May 12 buffer**: est. 19:30 ICT May 12 (US 8:30 AM ET); avoid new positions within 2h of release (~17:30–19:30 ICT May 12)

**Manual verification needed**:
- BTC exact price vs EMA200 ~$82,020 (est. $80,901; Prohibitive #6 confirmed active)
- ETH 1D EMA200 exact value (web consensus ~$2,367; prior entries carried ~$2,617 — live chart verification critical)
- Funding current 8h direction (est. −0.0020%/8h from CoinGlass; inconsistent with 20:08 reading — verify on Bybit)
- Whale ratio from Bybit Trading Trend (est. ~1.28; no public API)
- OI 24h direction (est. ~$33.6B; verify on Bybit)
- Gate 3 rejection candle counts at upper/lower edges on live 1H chart
