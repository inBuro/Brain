...
// selectedSend = k (0-based relative to AVAILABLE sends, i.e. offset already inside menu).
// buildRef() path "mixer_device sends selectedSend" — DIRECT Live index
// (Live treats sends[k] as the k-th send RELATIVE TO AVAILABLE for that track).
// Verified: on return track N sends[0] = sends[N+1] globally (Live automatically
// hides sends to own and earlier returns), so index stays 0-based.
