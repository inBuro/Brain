...
// #connect has no power-on state — it's purely the swap control, enabled as soon as EITHER deck
// has a track (swapping into an empty slot is a valid move, not just trading two live decks).
