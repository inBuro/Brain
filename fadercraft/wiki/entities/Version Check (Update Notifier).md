...
**Summary**: Фоновая проверка апдейтов внутри `XL_Performance.amxd`. На загрузке устройство пингует опубликованный манифест версии, сравнивает с собственной сборкой и, если вышла новее, подсвечивает ментоловую кнопку **«Update ready»**, ведущую на страницу покупки/обновления.
