...
// and outputs 1 (update available) / 0 to the node.script outlet.
// Edit DEVICE_VERSION on release to match the device's own build.
const maxApi = require('max-api');
const https  = require('https');

const DEVICE_VERSION = '1.0';                                   // this build's version
...
async function check() {
  ...
  maxApi.outlet(dot);                                         // 1 = update available, 0 = up to date / unknown
