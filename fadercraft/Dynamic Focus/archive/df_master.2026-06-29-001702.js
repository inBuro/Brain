// df_master.js — DYNAMIC FOCUS "MASTER" engine (by-name mapping, 48 slots, 6 pages × 8 rows).
//
// ONE master device on a MIDI track that receives the controller. 48 slots across 6 pages;
...
//       OR page command (list): [page, N]  (N = 0-based page index, 0..5)
...
//
// Pagination:
//   NSLOTS = 48 (6 pages × 8 rows). currentPage selects which 8 slots map to visible rows 0..7.
//   Physical slot index = currentPage * PAGE_SIZE + row.
//   Compatibility: setvalueof from old 8-slot sets loads into slots 0..7 (page 1) — preserved.
...
var PAGE_SIZE = 8;
var NPAGES    = 6;
var NSLOTS    = PAGE_SIZE * NPAGES;  // 48
