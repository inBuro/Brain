// df_master.js — DYNAMIC FOCUS "MASTER" engine, v6.2 (thispatcher hide/show, real-time note, pushNote debounce)
//
...
function handleCmd(a) {
    ...
    if (first === "pgname") {
        ...
        renderNote();          // immediately update placeholder visibility
        schedulePushNote(currentPage);  // debounced persist (400ms after last keystroke)
        return;
    }
    var visRow = first;
