...
Ten-block shape from `portfolio/portfolio/marketguard-case-copy-2026-08-16.md`.
...
`portfolio/raw/beefy-testing-promo-endcard.png`.
...
response — full dump saved to `portfolio/research/maze-filtering-report-2026-08-19.md`.
...
`portfolio/research/maze-boosts-mobile-report-2026-08-19.md`.
...
"Feb 2025 – Present": `portfolio/resume/resume.md`, `cv/index.html`, `cv/ru/index.html`,
