...
| Source | What it gave |
|---|---|
| `portfolio/research/finchguard-case-vocabulary-2026-08-15.md` | node-level before/after for this exact case, 6 rounds, with what was already applied to the artboard |
| `portfolio/resume/resume.md` | period, role, client, the achievement list with baselines |
